                    ...
                    child: Row(
                      children: [
                        ...
                        GestureDetector(
                          ...
                          color: items[index]["liked"] == true ? Colors.red : Colors.white,),
                          
                          onDoubleTap: (){
                            setState(() {
                              items[index]["liked"] = !items[index]["liked"];
                              items[index]["liked"] == true ? items[index]["likecount"]=items[index]["likecount"]+1 : items[index]["likecount"] = items[index]["likecount"]-1;
                            });
                          },
                        ),
                        Text("${items[index]["likecount"]}")
                      ],
                    ),
                  ),
                );
